...
public record Menu(Float cout, Plat plat, Boisson boisson) {
    public static List<Menu> getMenus(Connection connection, Integer restaurateurId) throws SQLException {
        ...
        try (PreparedStatement stmt = connection.prepareStatement(sql)) {
            ...
            while (resultSet.next()) {
                ...
                Boisson boisson = Boisson.getBoisson(connection, resultSet.getInt("boisson_id"));

                if (boisson == null || plat == null) {
                    continue;
                }
