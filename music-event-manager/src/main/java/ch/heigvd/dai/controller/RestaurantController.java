...
public class RestaurantController {
    ...
    public Context getOne(Context ctx) throws SQLException {
        ...
        return ctx.render("restaurateur.jte", Map.of("restaurateur", Restaurant.getRestaurateur(connection, id), "plats", Plat.getPlats(connection, id), "boissons", Soda.getBoissons(connection, id), "menus", Menu.getMenus(connection, id)));
    }
}
